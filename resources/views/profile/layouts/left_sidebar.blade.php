    ...
    <div class="sidebar left">
        ...
        <div class="my-account-nav-container">
            ...
            <ul class="my-account-nav">
                ...
                <li><a href="{{ route('my-profile') }}" @if (request()->routeIs('my-profile')) class="current" @endif><i class="sl sl-icon-user"></i> My Profile</a></li>
            ...
            <ul class="my-account-nav">
                <li><a href="{{route('profilePassword')}}" @if (request()->routeIs('profilePassword')) class="current" @endif><i class="sl sl-icon-lock"></i> Change Password</a></li>
                <li>
